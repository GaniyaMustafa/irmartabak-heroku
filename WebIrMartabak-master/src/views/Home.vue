  ...
  <div class="home">
    <section id="landing">
      <carousel
        ...
        :loop="true"
      >
        <slide v-bind:key="i" v-for="i in 3">
          <div class="container-fluid row p-0 m-0">
            <div class="col-md-6 p-0 my-auto">
              ...
              >
                <p class="lead">Martabak Super Sapi Mozzarella!</p>
                <div class="rating h4">
                ...
                <h1 class="display-3 mb-5 price">Rp 60.000</h1>
                <p class="lead">
                  <a
    ...
    <section id="aboutus">
      ...
      >
        <div class="col-md-5 col-sm-12 p-0 ">
          <img class="w-100 martabak" src="@/assets/img/stand.jpg" alt="" />
        </div>
    ...
    <section class="py-5" id="available">
      ...
      <div class="container-fluid row mt-5 p-0 m-0 mx-auto">
        <div class="col-md-6 p-0 text-center my-5">
          <img src="@/assets/img/gofood.png" class="w-50" srcset="">
        </div>
        <div class="col-md-6 p-0 text-center my-5">
          <img src="@/assets/img/grabfood.png" class="w-50" srcset="">
        </div>
      </div>
    </section>
  </div>
